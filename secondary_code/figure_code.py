...
stroop_cor_w_rt_diff_nort_fp = (f'{outdir}/stroop_lev2_output/'
    ...
    'constant_lev2_model_rt_diff/mean_diff0_2sided_tfce_corrp_fstat2.nii.gz')
stroop_cor_w_rt_diff_yesrt_fp = (f'{outdir}/stroop_lev2_output/'
    'stroop_lev1_contrast_stroop_incong_minus_cong_rtmod_rt_uncentered_duration_'
    'constant_lev2_model_rt_diff/'
...
# No overlap, because there aren't any active voxels when adjusting for RT 
